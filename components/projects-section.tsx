...
export function ProjectsSection() {
  const projects = [
    ...
    // 🔥 NEW PROJECT ADDED
    {
      ...
      description:
        'Parity is a full-stack SaaS platform where users track golf scores, participate in gamified draw rewards, and contribute to charities through a subscription-based system. It combines performance tracking, real-time competition, and social impact with secure admin controls and scalable architecture.',
      tech: [
        'React 19',
        'Vite',
        'Tailwind CSS',
...

    {
      ...
      description:
        'Comprehensive healthcare platform with AI-powered diagnostics, patient management, and intelligent scheduling using advanced ML models.',
...

    {
      ...
      description:
        'Full-stack job portal with AI-powered job matching, resume screening, and automated candidate recommendations using NLP.',
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex gap-4">
                      ...
                      <motion.a
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary to-accent text-background rounded-lg hover:shadow-lg transition-all text-sm font-medium"
                        style={{
